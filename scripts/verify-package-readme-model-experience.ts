...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-preset-transfer': { kind: 'none', reason: 'Browser-side archive transfer settings; registers nothing model-facing.' },
  'packages/client/ui-mobile-remote': { kind: 'none', reason: 'Browser-side phone-pairing settings surface; registers nothing model-facing.' },
  ...
  'packages/preset/preset-transfer': { kind: 'none', reason: 'Host-side archive transfer service; registers no prompt, tool, message, or provider request.' },
  ...
  'packages/host/mobile-remote': { kind: 'none', reason: 'Optional LAN pairing and mobile-control service; registers no model-facing behavior.' },
