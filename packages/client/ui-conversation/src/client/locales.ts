...
export const zh = {
  ...
  'image.dropTitle': '拖动图片或文件到此处即可添加',
  'image.dropDesc': '图片最多 {count} 张、每张 {size}；其他文件仅添加引用',
...
export const en = {
  ...
  'image.dropDesc': 'Up to {count} images, {size} each; other files are references only',
  ...
  'file.remove': 'Remove file reference {name}',
