...
- `@deepseek-ai/dsh-host-plugin-inventory` — requires `loader` · `subprocess` ([`packages/host/plugin-inventory/src/index.ts`](../packages/host/plugin-inventory/src/index.ts))
